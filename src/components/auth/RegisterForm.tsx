  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center">Únete a FitApp y comienza tu transformación fitness</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="fullName">Nombre Completo</Label>
          <Input id="fullName" type="text" placeholder="Juan Pérez" className="w-full" />
        </div>
